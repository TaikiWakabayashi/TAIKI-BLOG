...
const Category = /*#__PURE__*/ (0,external_react_.memo)(({ categoryName , index  })=>{
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_Header_Header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4734);
/* harmony import */ var _components_Top_top__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(881);
/* harmony import */ var _components_NewPost_NewPost__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4548);
/* harmony import */ var _components_PickUp_pickup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8621);
/* harmony import */ var _components_Category_category__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4329);
/* harmony import */ var _components_Footer_footer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8033);
/* harmony import */ var _hooks_useHeaderScroll__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8359);
/* harmony import */ var _lib_api__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(2523);
...
const Home = ({ blogs , newPosts , pickupPosts  })=>{
    const isHeaderActive = (0,_hooks_useHeaderScroll__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(300);
    const [blogState, setBlogState] = (0,recoil__WEBPACK_IMPORTED_MODULE_10__.useRecoilState)(_context_blogContext__WEBPACK_IMPORTED_MODULE_11__/* .blogsStates */ .Oc);
    const setNewPostState = (0,recoil__WEBPACK_IMPORTED_MODULE_10__.useSetRecoilState)(_context_blogContext__WEBPACK_IMPORTED_MODULE_11__/* .newPostStates */ .$F);
    const setPickUpState = (0,recoil__WEBPACK_IMPORTED_MODULE_10__.useSetRecoilState)(_context_blogContext__WEBPACK_IMPORTED_MODULE_11__/* .pickupStates */ .$c);
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_Top_top__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {}),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_NewPost_NewPost__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {}),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_PickUp_pickup__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {}),
            blogState.value.map(({ category  }, index)=>{
                return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_Category_category__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
...
const getStaticProps = async ()=>{
    ...
    // 最新記事（作成日）を４記事取得
    const newPosts = await (0,_lib_api__WEBPACK_IMPORTED_MODULE_8__/* .getBlogBySortCreateDate */ .d7)();
    // カテゴリIDのリスト作成
    const IdArray = categories.contents.map(({ id  })=>{
        return id;
    });
    // カテゴリ名のリスト作成
    const categoryNameArray = categories.contents.map(({ name  })=>{
        return name;
    });
    // 各カテゴリの記事を4件取得し、配列に格納
    const contentsArray = [];
    for (let id of IdArray){
        const blogs = await (0,_lib_api__WEBPACK_IMPORTED_MODULE_8__/* .getBlog */ .x3)(id);
    ...
    // pickupが"Yes"の記事を取得
    const pickupArray = await (0,_lib_api__WEBPACK_IMPORTED_MODULE_8__/* .getPickUpBlog */ .cX)();
    return {
        props: {
            blogs: objArray,
